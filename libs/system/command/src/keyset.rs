...
lazy_static! {
    ...
    static ref KEYCODES: HashMap<Ascii<&'static str>, Key> = {
        ...
        m.insert(Ascii::new("NumpadAdd"), Key::Virtual(VirtualKeyCode::NumpadAdd));
        m.insert(Ascii::new("NumpadComma"), Key::Virtual(VirtualKeyCode::NumpadComma));
        m.insert(Ascii::new("NumpadDecimal"), Key::Virtual(VirtualKeyCode::NumpadDecimal));
        m.insert(Ascii::new("NumpadDivide"), Key::Virtual(VirtualKeyCode::NumpadDivide));
        ...
        m.insert(Ascii::new("NumpadMultiply"), Key::Virtual(VirtualKeyCode::NumpadMultiply));
        m.insert(Ascii::new("NumpadSubtract"), Key::Virtual(VirtualKeyCode::NumpadSubtract));
